    ...
    return(
        <div className="footer">
            <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3">
                            <div className="footer-about">
                                <p>ПРО КЛІНІКУ</p>
                                <ul>
                                    <li><Link to="/about" className="navbar-link text-sm">Про нас</Link></li>
                                    <li><Link to="/prices" className="navbar-link text-sm">Ціни</Link></li>
                                    <li><Link to="/actions" className="navbar-link text-sm">Акції</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-3">
                            ...
                            <ul>
                                ...
                                <li className="text-sm">
                                    ...
                                    <a href="tel:+38098-507-19-88" className="phone text-sm">+38 (098) 507 19 88</a>
                                </li>
                            </ul>
                            <ul>
                                <li className="text-sm">
                ...
                <p className="copyright text-sm">© 2020 | Всі права захищені Солодент</p>
            </div>
        </div>
    )
};
