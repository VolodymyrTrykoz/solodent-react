const ourTeamInfo = [
  ...
  },
  {
    ...
    description: `
      ...
      <p class="accordion__text">Закінчила НМУ ім. О.О. Богомольця за спеціальністю "стоматолог"</p>
  ...
  },
  {
    ...
    location: 'Бровари',
    locationId: ['brovary'],
    qualification: ['Терапевт', 'Косметолог'],
    description: `
      <p class="accordion__text">Лікар-стоматолог загального прийому</p>
      <p class="accordion__text">Закінчила НМУ ім. О.О. Богомольця за спеціальністю "стоматологія".</p>
      <p class="accordion__text">Основні напрямки роботи:</p>
        <ul class="accordion__list">
  ...
  {
    id: 7,
    name: 'Алькам Джаміля Мухамедівна',
    location: 'Київ',
    locationId: ['kyiv'],
    qualification: ['Стоматолог ', 'Терапевт'],
    description: `
      ...
      <p class="accordion__text">Курси:</p>
        <ul class="accordion__list">
          <li class="accordion__list-item">«Реставраційні рішення для відновлення зубів по класу ІІ» Дмитро Неліпа</li>
          <li class="accordion__list-item">«Діагностика в ендодонтії» Ігор Ноєнко</li>
          <li class="accordion__list-item">«Планування естетичної реабілітації» Максим Белоград</li>
